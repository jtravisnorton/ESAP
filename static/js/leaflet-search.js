...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
	...
	onAdd: function (map) {
		this._map = map;
		this._container = L.DomUtil.create('div', 'leaflet-control-zoom leaflet-bar leaflet-control leaflet-control-search');
		this._input = this._createInput(this.options.text, 'form-control search-input');
